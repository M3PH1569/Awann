<div id="editModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center p-4 z-50">
    <div class="bg-white border border-gray-200 rounded-md w-full max-w-lg p-6 md:p-8 shadow-xl relative">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button onclick="closeModal('editModal')" class="absolute right-3 top-3 text-black text-lg font-bold focus:outline-none">
        ...
        <form id="editMutasi" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="edit_noreg" class="w-full bg-[#D0E4FE] text-sm text-[#1C4D8D] font-semibold border rounded-md p-2 focus:outline-none" disabled>
            </div>
            ...
            <div>
                ...
                <textarea id="edit_ket" name="keterangan" rows="3" placeholder="Mau buat apa?" class="w-full border rounded-sm p-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#1C4D8D] resize-none"></textarea>
            </div>
            ...
            <div class="flex justify-end gap-2 pt-1">
                ...
                <button type="submit" id="btn_submit_edit" class="bg-[#1C4D8D] text-white text-sm px-3 py-2 rounded-md font-semibold shadow hover:bg-[#3E679E] transition">Simpan</button>
            </div>
