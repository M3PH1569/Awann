<div id="historyModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center p-4 z-50">
    <div class="bg-white border border-gray-200 rounded-md w-full max-w-4xl shadow-xl flex flex-col max-h-[85vh] overflow-hidden">
        ...
        <div class="flex justify-between items-center px-6 py-4 border-b sticky top-0 bg-white z-10">
            ...
            <button onclick="closeModal('historyModal')" class="absolute right-3 top-2 text-black text-lg font-bold focus:outline-none">
