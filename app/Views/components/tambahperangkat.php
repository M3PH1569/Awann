<div id="tambahModal" class="fixed inset-0 z-[60] hidden flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white rounded-lg shadow-xl w-[90%] max-h-[85vh] overflow-hidden flex flex-col transition-all duration-300" id="tambahModalContent" style="max-width:500px">

        <div class="bg-[#1C4D8D] text-white px-4 py-3">
        ...
        <div id="tabContentCsv" class="hidden flex flex-col flex-1 overflow-hidden">
            ...
            <div id="csvUploadZone" class="p-4">
                ...
                <div class="flex items-center justify-between mt-3">
                    <p class="text-xs text-gray-400">Format: <code class="bg-gray-100 px-1.5 py-0.5 rounded">.csv</code> <code class="bg-gray-100 px-1.5 py-0.5 rounded">.xlsx</code> <code class="bg-gray-100 px-1.5 py-0.5 rounded">.xls</code> — kolom: <code class="bg-gray-100 px-1.5 py-0.5 rounded">noreg, nama</code></p>
            ...
            <!-- Preview Area (hidden until CSV is loaded) -->
            <div id="csvPreviewArea" class="hidden flex flex-col flex-1 overflow-hidden">

                <!-- Summary Bar -->
                <div class="px-4 pb-2 flex items-center gap-3 flex-wrap">
